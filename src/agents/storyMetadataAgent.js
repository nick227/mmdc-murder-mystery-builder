...
export async function storyMetadataAgent(context) {
  const prompt = {
    system:
      'You package murder-mystery dinner party experiences for hosts. Return concise JSON only: title, short description, age/content rating, and comma-separated theme tags suitable for marketing.',
    user: `
Host prompt: ${String(context.userPrompt || '').trim()}
...
- story_description: 2–4 sentences for the host and players
